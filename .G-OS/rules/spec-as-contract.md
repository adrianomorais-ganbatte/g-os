...
**Baseado em:**
- `context-gos/OpenSpec-main (histórico)` (spec-driven development framework)
- `context-gos/spec-kit-main (histórico)` (GitHub spec-kit toolkit)
- `prompts/02-spec.md` (spec canônica do G-OS)
...
O fluxo canônico de spec-driven development no G-OS:
