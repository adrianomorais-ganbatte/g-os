...
IDE-FILE-RESOLUTION:
  ...
  - Dependencies map to .a8z/{type}/{name}
  - type=folder (tasks|templates|checklists|data|utils|etc...), name=file-name
  - Example: create-doc.md → .a8z/tasks/create-doc.md
...
activation-instructions:
  ...
  - STEP 3: |
      Activate using .a8z/scripts/unified-activation-pipeline.js
  ...
  coderabbit_integration:
    ...
    workflow: |
      ...
      WHILE iteration < max_iterations:
        1. Run: wsl bash -c 'cd /mnt/c/.../@synkra/a8z-core && ~/.local/bin/coderabbit --prompt-only -t committed --base main'
...
**Memory scope:** `project` — Acumula test patterns, fixtures e failure patterns do projeto.
**Effort:** `high` — QA requer analise minuciosa de edge cases.
**Skills preload:** `quality-assurance`, `test-driven-dev` — Injeta frameworks de teste e validacao.
